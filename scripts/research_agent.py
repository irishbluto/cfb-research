...
{{
  ...
  "sentiment_score": 0.0,
  "agent_summary": "4-5 dense, specific sentences a CFB analyst would write.  The audience is college football fans that are looking for in depth knowledge about each of the 138 FBS teams.  In early_offseason, spring_offseason and preseason they are looking for how information on how good each team is, who are their top players, how is their coaching staff performing and how well they will perform in the upcoming season.  In these modes you Must include: (1) the team's single most important current narrative with specific player names and/or numbers, (2) the biggest concern or question mark with concrete evidence, (3) one context-setter such as a key schedule game, ranking, or historical note. Avoid generic phrases like 'enters 2026 with questions' or 'looks to build on last year.'"
